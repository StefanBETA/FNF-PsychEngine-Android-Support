...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		...
		['Super, 0.7], //69%
		['Dobro', 0.8], //From 70% to 79%
		['Odlicno, 0.9], //From 80% to 89%
	...
	override public function update(elapsed:Float)
	{
		...
		if(ratingName == '?') {
			scoreTxt.text = 'Rezultat: ' + songScore + ' | Broj Gresaka: ' + songMisses + ' | Ocena: ' + ratingName;
		} else {
			scoreTxt.text = 'Rezultat: ' + songScore + ' | Broj Gresaka: ' + songMisses + ' | Ocena: ' + ratingName + ' (' + Highscore.floorDecimal(ratingPercent * 100, 2) + '%)' + ' - ' + ratingFC;//peeps wanted no integer rating
		}
